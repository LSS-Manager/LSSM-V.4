...
## na GitHubie
Możesz również otworzyć problem na [GitHubie][github.issues]. Sprawdź tutaj, czy rozwiązanie dotyczące tego problemu już istnieje, a następnie postępuj zgodnie z nim.
