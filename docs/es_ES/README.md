...
Si Tampermonkey ha sido instalado con éxito en tu navegador, puedes hacer click [AQUI](https://proxy.lss-manager.de/v4/lssm-v4.user.js) para descargar e instalar el Script para que posteriormente funcione.
