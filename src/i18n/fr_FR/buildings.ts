...
export default {
    ...
    4: {
        ...
        extensions: [
            ...
            },
            {
                ...
                maxExtensionsFunction: buildingsByType =>
                    Math.floor(
                        (Object.keys(buildingsByType[4] ?? {}).length ?? 0) / 5
                    ),
                canBuyByAmount: (boughtExtensionsAmountByType, maxExtensions) =>
    ...
    26: {
        ...
        extensions: [
            ...
            {
                caption: "Hangar pour avions bombardiers d'eau",
                credits: 100_000,
                coins: 15,
                duration: '2 jours',
                isVehicleExtension: true,
            ...
            {
                caption: "Hangar supplémentaire pour avions bombardiers d'eau",
                credits: 200_000,
                coins: 15,
                duration: '4 jours',
                isVehicleExtension: true,
    ...
    27: {
        ...
        extensions: [
            ...
            {
                caption: 'BMSC - Brigade Militaire de la Sécurité Civile',
                credits: 200_000,
                coins: 25,
                duration: '5 jours',
                isVehicleExtension: true,
            ...
            ...multiplyExtension(
                index => ({
                    caption: 'Emplacement de cellule supplémentaire',
                    credits: 100_000,
                    coins: 20,
                    duration: '5 jours',
                    isVehicleExtension: true,
                    givesParkingLots: 1,
                    requiredExtensions: index ? [index + 4] : [],
                    cannotDisable: true,
                }),
                5
            ),
            {
                caption: 'Cellule épuisement',
                credits: 200_000,
                coins: 25,
                duration: '5 jours',
                isVehicleExtension: true,
            ...
            },
            {
                ...
                isVehicleExtension: true,
                givesParkingLots: 1,
                unlocksVehicleTypes: [56, 73, 99],
            },
            {
                caption: 'Extension pour véhicule ferroviaire',
                credits: 200_000,
                coins: 25,
                duration: '5 jours',
                isVehicleExtension: true,
                givesParkingLots: 2,
                unlocksVehicleTypes: [113, 114, 115, 116, 117, 118, 119],
            },
        ],
        levelcost: [
            '1. 10 000',
    ...
    30: {
        caption: 'Gendarmerie haute montagne',
        color: '#116611',
        coins: 50,
        credits: 500_000,
        levelPrices: {
            credits: [
                ...
                75_000,
                ...Array(5).fill(100_000),
                ...Array(3).fill(150_000),
            ],
            coins: [5, 10, 10, 15, ...Array(8).fill(20)],
        },
        extensions: [
            {
                caption: 'QUAD haute montagne',
                credits: 200_000,
                coins: 25,
                duration: '5 jours',
                isVehicleExtension: true,
                givesParkingLots: 2,
                parkingLotReservations: [[83], [83]],
                unlocksVehicleTypes: [83],
            },
            {
                caption: 'Chiens de sauvetage (PGHM)',
                credits: 350_000,
                coins: 25,
                duration: '5 jours',
                isVehicleExtension: true,
                givesParkingLots: 2,
                parkingLotReservations: [[88], [88]],
        ...
        startParkingLots: 2,
        startVehicles: [],
        schoolingTypes: ['Peloton de haute montagne'],
        schools: [31],
        icon: 'building-shield',
    },
    31: {
        ...
        startParkingLots: 1,
        startVehicles: [],
        school: 'Peloton de haute montagne',
        icon: 'building-shield',
    },
