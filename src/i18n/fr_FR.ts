...
export default {
    modules,
    serverUmzugWarning: `Une maintenance du serveur aura lieu le jeudi 15.09.2022 à partir de 14h (heure locale : {local}). LSSM et les scripts utilisant l'API de LSSM seront indisponibles pendant quelques heures !`,
    updateUserscript: {
