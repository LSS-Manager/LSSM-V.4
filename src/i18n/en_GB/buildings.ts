...
export default {
    ...
    4: {
        ...
        extensions: [
            ...
            },
            {
                ...
                maxExtensionsFunction: (
                    buildingsByType: Record<number, Building[]>
                ): number => Math.floor((buildingsByType[4]?.length ?? 4) / 3),
                canBuyByAmount: (boughtExtensionsAmountByType, maxExtensions) =>
            ...
            },
            {
                ...
                maxExtensionsFunction: (
                    buildingsByType: Record<number, Building[]>
                ): number => Math.floor((buildingsByType[4]?.length ?? 4) / 9),
                canBuyByAmount: (boughtExtensionsAmountByType, maxExtensions) =>
                    (boughtExtensionsAmountByType[4][9] ?? 0) < maxExtensions,
                newBeds: 10,
                requiredExtensions: [9],
    ...
    7: {
        ...
        levelcost: [],
        maxBuildings:
            'For every 10 buildings, you can build one control center',
        maxLevel: 0,
    ...
    22: {
        ...
        startPersonnel: 1,
        startVehicles: [''],
        schoolingTypes: ['Rescue', 'Police', 'Fire', 'Search and Rescue'],
        schools: [2, 3, 8, 29],
        startParkingLots: 1,
        icon: 'house-flag',
    },
    ...
    27: {
        ...
        startPersonnel: 5,
        startVehicles: [''],
        schoolingTypes: ['Search and Rescue'],
        schools: [29],
        startParkingLots: 1,
