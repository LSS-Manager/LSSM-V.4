...
export default {
    ...
    'Water Rescue': [
        ...
        },
        {
            ...
            duration: '5 Days',
            staffList: 'Coastal Command Training',
            key: 'coastal_command',
        },
        {
            caption: 'Mud Rescue Training',
            duration: '3 Days',
            staffList: 'Mud Rescue Training',
        ...
        },
        {
            ...
            duration: '3 Days',
            staffList: 'Rope Rescue Training',
            key: 'gw_hoehenrettung',
        },
        {
            caption: 'Flood First Responder Training',
            duration: '3 Days',
            staffList: 'Flood First Responder Training',
            key: 'flood_equipment',
        },
        {
            caption: 'Lifeguard Training',
