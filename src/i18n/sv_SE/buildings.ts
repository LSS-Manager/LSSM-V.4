...
export default {
    ...
    25: {
        ...
        special: '',
        startClassrooms: 0,
        school: 'Kustbevakningsstation',
        icon: 'graduation-cap',
    },
    26: {
        caption: 'Kustflygsstation',
        color: '#11858d',
        coins: -1,
        credits: -1,
        levelPrices: {
    ...
    28: {
        caption: 'Kustnära volontärgrupper',
        color: '#11858d',
        coins: -1,
        credits: -1,
        levelPrices: {
