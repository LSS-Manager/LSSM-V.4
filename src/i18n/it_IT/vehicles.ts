...
export default {
    ...
    46: {
        caption: 'Pattuglia Guardia Costiera',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    49: {
        caption: 'Elicottero Guardia Costiera',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    50: {
        caption: 'Aereo Guardia Costiera',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    62: {
        caption: 'Escavatore Piccolo su Rimorchio',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    63: {
        caption: 'Camion Movimento Terra',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    64: {
        caption: 'AV/CA Unità Cinofila SAR',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    65: {
        caption: 'AF Unità Cinofila SAR',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
        icon: 'car-side',
        possibleBuildings: [0, 18, 30],
    },
    66: {
        caption: 'ACT/Scar PC',
        color: '#0a2bff',
    ...
    67: {
        caption: 'Modulo Scarrabile Movimento Terra',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    72: {
        caption: 'Funzionario AIB - DOS PC',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
    ...
    74: {
        caption: 'Autocarro AIB - AF/BOSC PC',
        color: '#0a2bff',
        credits: -1,
        coins: -1,
        staff: { min: 1, max: 2 },
