...
export default {
    ...
    vehicles: {
        ...
        34: {
            ...
            special: 'Required once you have built 15 Rescue stations. It is required for missions that can spawn with over 20 patients to help command the scene it is a dual unit between a OTL and a Ambulance Officer Requirements',
        },
    },
    buildings: {
        0: {
