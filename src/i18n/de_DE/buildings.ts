...
export default {
        ...
        extensions: [
            {
                ...
                duration: '3 Tage',
                isVehicleExtension: true,
                unlocksVehicleTypes: [157],
            },
        ],
        storageUpgrades: {
            initial_helicopter_equipment: {
                caption: 'Lagerraum für Rettungswinden',
                additionalStorage: 40,
                credits: 25_000,
                coins: 10,
                duration: '5 Tage',
    ...
    9: {
        ...
        extensions: [
            ...
            {
                caption: 'Fachgruppe Logistik-Verpflegung',
                credits: 50_000,
                coins: 15,
                duration: '7 Tage',
                isVehicleExtension: true,
    ...
    11: {
        ...
        extensions: [
            ...
            {
                caption: 'Sonderfahrzeug: Lautsprecherkraftwagen',
                credits: 100_000,
                coins: 10,
                duration: '5 Tage',
                isVehicleExtension: true,
                givesParkingLots: 1,
                unlocksVehicleTypes: [165],
                parkingLotReservations: [[165]],
                unlockedVehiclesOnReservedLotsOnly: true,
            },
        ],
