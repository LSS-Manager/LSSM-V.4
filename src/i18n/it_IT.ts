...
export default {
    modules,
    serverUmzugWarning: `Ci sarà una manutenzione dei server giovedì 15/09/22 dalle ore 14 ({local}). Gli script LSSM e coloro che usano l'API di LSSM non saranno raggiungibili per un paio d'ore!`,
    updateUserscript: {
