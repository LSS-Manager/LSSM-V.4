...
export default {
    ...
    126: {
        ...
        icon: 'car-side',
        special: 'Vehicle used transport containers.',
        possibleBuildings: [29],
    },
    127: {
        caption: 'WTC (Container)',
        color: '#6b1ebe',
        credits: 8500,
        coins: 12,
        staff: {
        ...
        icon: 'car-side',
        special: 'Water Containter Tanker.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    128: {
        caption: 'FBPC (Container)',
        color: '#6b1ebe',
        credits: 11_680,
        coins: 8,
        staff: {
        ...
        icon: 'car-side',
        special: 'Fire Breath Protection Container.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    129: {
        caption: 'USARC (Container)',
        color: '#6b1ebe',
        credits: 5000,
        coins: 8,
        staff: {
        ...
        icon: 'car-side',
        special: 'Urban Search and Rescue Container.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    130: {
        caption: 'HazMat (Container)',
        color: '#6b1ebe',
        credits: 5000,
        coins: 8,
        staff: {
    ...
    131: {
        ...
        icon: 'car-side',
        special: 'Incident Command Post Container.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    132: {
        caption: 'CWFT (Container)',
        color: '#6b1ebe',
        credits: 6000,
        coins: 12,
        staff: {
        ...
        icon: 'car-side',
        special: 'Combined Water and Foam Tanker.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    133: {
        caption: 'FWDC (Container)',
        color: '#6b1ebe',
        credits: 15_000,
        coins: 15,
        staff: {
        ...
        icon: 'car-side',
        special: 'Flood and Water Damage Container.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
    134: {
        caption: 'FRC (Container)',
        color: '#6b1ebe',
        credits: 7000,
        coins: 10,
        staff: {
        ...
        icon: 'car-side',
        special: 'Fire Rolling Container.',
        possibleBuildings: [29],
        isTrailer: true,
        tractiveVehicles: [126],
    },
