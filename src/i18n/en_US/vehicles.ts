...
export default {
    ...
    96: {
        ...
        possibleBuildings: [0, 13],
        isTrailer: true,
        tractiveVehicles: [1, 3],
        special:
            'Needed towing vehicle (Battalion chief unit, Type 2 fire engine)',
    },
    97: {
        caption: 'Large Heavy Rescue Trailer',
        color: '#9f1616',
        credits: 12_000,
        coins: 15,
        staff: { min: 0, max: 0 },
    ...
    98: {
        ...
        possibleBuildings: [0, 13],
        isTrailer: true,
        tractiveVehicles: [0, 1, 3, 4, 8],
        special:
            'Needed towing vehicle (Battalion chief unit, Type 1 fire engine, Type 2 fire engine, Heavy rescue vehicle, Utility unit)',
    },
    99: {
        caption: 'Large HazMat Trailer',
        color: '#9f1616',
        credits: 18_000,
        coins: 15,
        staff: { min: 0, max: 0 },
    ...
    106: {
        ...
        icon: 'car-side',
        special: 'Has a crashed car capacity of 2 cars',
        possibleBuildings: [27],
    },
    107: {
        caption: 'Fire Wrecker',
        color: '#cc2222',
        credits: 15_000,
        coins: 15,
        staff: {
    ...
    111: {
        ...
        special:
            "Needed towing vehicle (Patrol car, K-9 Unit, Police Crew Carrier, Police Supervisor / Sheriff Unit, Warden's Truck, SWAT Armoured Vehicle, SWAT SUV, Tactical Rescue Truck)",
    },
    112: {
    ...
    114: {
        ...
        icon: 'car-side',
        special: 'Not used in US Yet.',
        possibleBuildings: [27],
    },
    115: {
        caption: 'Large Coastal Helicopter',
        color: '#6b1ebe',
        credits: 28_000,
        coins: 20,
        staff: {
    ...
    116: {
        caption: 'Small Fire Equipment Trailer',
        color: '#6b1ebe',
        credits: 10_000,
        coins: 10,
        staff: {
    ...
    121: {
        ...
        icon: 'car-side',
        special: 'Trailer used for transporting snow equipment.',
    ...
    122: {
        ...
        icon: 'car-side',
        special: 'Vehicle used for mountain rescue operations.',
        possibleBuildings: [28],
    },
    123: {
        caption: 'ATV Trailer',
        ...
        icon: 'car-side',
        special: 'Trailer used for transporting ATV.',
        possibleBuildings: [28],
    },
    124: {
        caption: 'Mountain Dog',
        color: '#6b1ebe',
        credits: 20_000,
        coins: 15,
        staff: {
        ...
        icon: 'car-side',
        special: 'Vehicle used for mountain dog operations.',
        possibleBuildings: [28],
    },
    125: {
        caption: 'Mountain Height Rescue',
        color: '#6b1ebe',
        credits: 20_000,
        coins: 15,
        staff: {
