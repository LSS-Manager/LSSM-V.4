module.exports = {
    ...
    enhancedMissingVehicles: {
        ...
        vehiclesByRequirement: {
            [/^– SH lub SD$/u]: [2, 13],
            [/^– Rchem$/u]: [41, 7, 49, 50],
            [/^[Aa]mbulanse(\(-ów\))?$/u]: [5, 31],
            [/^[Aa]mbulanse(\(-ów\))? OOP$/u]: [],
            [/^[Aa]mbulanse? P$/u]: [5, 31],
            [/^armatek wodnych$/u]: [],
            ...
            [/^radiowóz OPI$/u]: [8],
            [/^[Rr]adiow(oz(u|ów)|óz) OPP$/u]: [],
            [/^[Rr]adiow(oz(u|ów)|óz) straży miejskiej$/u]: [],
            [/^[Rr]adiow(oz(u|ów)|óz) WRAPRD$/u]: [],
            [/^[Rr]adiow(oz(u|ów)|óz) WRD?$/u]: [30],
            [/^Ruchomych Stanowisk Dowodzenia$/u]: [],
            ...
            [/^specjalistycznych sprzętów OPP$/u]: [],
            [/^SPGaz$/u]: [10, 42, 52],
            [/^sprzęty? przeciwpowodziow[ey]$/u]: [46, 51, 63],
            [/^wymaganych więźniarek$/u]: [],
        },
    },
    tailoredTabs: {
        allTab: 'All',
