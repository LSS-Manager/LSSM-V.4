module.exports = {
    ...
    enhancedMissingVehicles: {
        ...
        vehiclesByRequirement: {
            ...
            [/^AP nebo AZ$/]: [2, 10],
            [/^VEA$/]: [3, 17],
            [/^[Tt]echnický(ch)? automobilů?$/]: [4],
            [/^Protiplynov(ý(ch)?|é) automobil[yů]??$/]: [16],
            [/^Mobilní operační středisk[ao]$/]: [17],
            [/^Vozidel pro práci s nebezpečnými látkami$/]: [7],
            [/^KHA$/]: [6],
            [/^Sanitka$/]: [5],
            [/^Vrtulník LZS$/]: [9],
            [/^[Hh]lídkový vůz$/]: [8, 14],
            [/^Policejní(ch)? vrtulníků?$/]: [11],
            [/^URNA$/]: [12, 15],
            [/^Kynolog(ové)? Policie$/]: [13],
            [/^Vozidl[ao] vyšetřovatelů DN$/]: [18],
            [/^Vozid(lo|el) pyrotechik[aů] PČR$/]: [19],
            [/^Přívěsy? se člunem$/]: [20, 21],
