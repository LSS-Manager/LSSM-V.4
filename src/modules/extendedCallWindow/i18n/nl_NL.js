module.exports = {
    ...
    enhancedMissingVehicles: {
        ...
        vehiclesByRequirement: {
            ...
            [/^Redvoertuig(en)?$/u]: [2, 18],
            [/^Officier(en)? van Dienst - Brandweer$/u]: [3, 19],
            [/^Hulpverleningsvoertuig(en)?$/u]: [4, 51, 62],
            [/^AB$/u]: [5, 27],
            [/^Slangenwagen$/u]: [10, 29, 34, 45, 61],
            [/^watertankwagen of gelijkwaardige haakarmbak$/u]: [],
            [/^Hoofd Officier(en)? van Dienst$/u]: [19],
            [/^Commandowagen(s)?$/u]: [31, 32],
            [/^Verkenningseenh(eden|eid)$/u]: [11],
            [/^Adviseur(s)? Gevaarlijke Stoffen$/u]: [24],
            [/^Waterongevallenvoertuig(en)? \/ Oppervlaktereddingsteam(s)?$/u]:
                [33, 49, 50],
            [/^WOA( of BA-RB)?$/u]: [36, 67],
            ...
            [/^ME Commandovoertuig(en)?$/u]: [39],
            [/^ME Flexbus(sen)?$/u]: [40],
            [/^AT Commandant(en)?$/u]: [53],
            [/^AT Materiaalwagen(s)?$/u]: [55],
            [/^AT Operator(s)?$/u]: [54],
            [/^Ambulance(s)?$/u]: [16, 52, 57, 63],
            [/^Biketeam(s)?$/u]: [60],
            [/^Aanhoudingseenhe(den|id)$/u]: [64],
            [/^Dienstbus(sen)? Arrestantenvervoer$/u]: [58],
            [/^Er ontbre(ekt|ken):$/u]: [],
            [/^Arrestanten zullen vervoerd worden$/u]: [],
            [/^[Ss]trandvoertuig(en)?$/u]: [65, 66],
            [/^schuimblusvoertuig(en)?$/u]: [41, 42, 43, 68, 69, 70],
            [/^Pompvoertuig(en)?$/u]: [71, 72],
        },
    },
    tailoredTabs: {
        allTab: 'Alles',
