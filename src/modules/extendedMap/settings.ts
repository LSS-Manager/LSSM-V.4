...
export default <ModuleSettingFunction>(async (MODULE_ID, LSSM, $m) => {
    ...
    return {
        ...
        //     default: [],
        // },
        mapStyleFilter: <Toggle>{
            type: 'toggle',
            default: false,
            noMapkit: true,
        },
        mapStyleFilterInvert: <Slider>{
            type: 'number',
            default: 0,
            min: 0,
            max: 100,
        ...
        mapStyleFilterBrightness: <Slider>{
            type: 'number',
            default: 0,
            min: 1, //Prevent users to make their map completely black
            max: 200,
            step: 1,
            float: false,
            dependsOn: '.mapStyleFilter',
