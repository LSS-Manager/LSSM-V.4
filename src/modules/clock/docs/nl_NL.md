...
Momenteel bieden wij u de mogelijkheid horloges aan op de volgende locaties:
* avigatiebalk * Formaat hier: `LLLL: ss` *! [Klok in de navigatiebalk](/docs/assets/clock/img/navbar.png)
...
| :-----------: | :------: | :--------------------------------: | :----------------------------------------------------------: |
|     Maand     |    M     |       `1` `2` ... `11` `12`        | DDeze variabele geeft de huidige maand als een getal weer. Er wordt geen `0`voor getallen van 1 cijfer geplaatst. |
...
|               |   ddd    |    `Zo` `Ma` ... `Vr` `Za`     | eze variabele geeft de korte vorm van de huidige weekdag als een woord weer gevolgd door een punt `.`. In de Engelstalige spelversies wordt een afkorting van 3 cijfers zonder punt gebruikt |
...
|    Seconden    |    s     |       `0` `1` ... `58` `59`        | Deze variabele geeft de huidige seconde weer. Er wordt geen `0` voor getallen van 1 cijfer geplaatst. |
