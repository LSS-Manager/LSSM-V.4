...
// @version      4.4.6+CZ-DK-DE-AU-GB-US-ES-MX-FI-FR-IT-JP-KR-NO-NL-PL-BR-PT-RO-RU-SK-SE-TR-UA
...
// ==/UserScript==
var _a,loadLSSM=function(){var e=document.createElement("script");e.src="".concat("https://proxy.lss-manager.de/v4/","core.js?_=").concat((new Date).getTime(),"&uid=").concat(I18n.locale,"-").concat(user_id),e.setAttribute("type","module"),e.setAttribute("async",""),document.body.appendChild(e)};window.frameElement&&!(null===(_a=window.frameElement)||void 0===_a?void 0:_a.src.startsWith("https"))||window.location.pathname.match(/^\/users\//)||"undefined"==typeof user_id||"undefined"==typeof I18n||window.hasOwnProperty("lssmv4")||(window!==window.parent&&window.parent.hasOwnProperty("lssmv4-redesign-lightbox")?(window.parent.addEventListener("lssmv4-redesign-iframe-trigger-lssm-load",loadLSSM),window.parent["lssmv4-redesign-lightbox"].src=new URL(window.location.href).toString()):loadLSSM());
